...
Проект хранит пользователей, курсы валют, цели, настройки уведомлений и уведомления в PostgreSQL.
...
- получение истории курсов USD, EUR и CNY за 7 дней
- CRUD для целей
...
- `api` обрабатывает HTTP-запросы, auth, цели, настройки и уведомления
- `worker` получает курсы из внешнего API, сохраняет их и их историю в БД и проверяет цели
